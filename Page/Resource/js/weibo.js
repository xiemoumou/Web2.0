...
$(document).ready(function(){
    ...
    $('.commentAll').on('click','.plBtn',function(){
        ...
        console.log(oSize);
        var commentator = nickName;
        //动态创建评论模块
        oHtml = '<div class="comment-show-con clearfix"><div class="comment-show-con-img pull-left">'
        +'<img src="../images/images/073928257.jpg" alt=""></div>' 
        +'<div class="comment-show-con-list pull-left clearfix"><div class="pl-text clearfix">' 
        +'<a href="#" class="comment-size-name">'+ commentator +' : </a> <span class="my-pl-con">'
        + oSize +'</span> </div> <div class="date-dz"> <span class="date-dz-left pull-left comment-time">'
    ...
    $('.comment-show').on('click','.hf-pl',function(){
        ...
        if(oHfVal.replace(/^ +| +$/g,'') == '' || oHfVal == oAllVal){
            ...
            $.getJSON("../json/pl.json",function(data){
                ...
                +'<a href="#" class="comment-size-name">'+ commentator +'</a><span class="my-pl-con">'
                + oAt +'</span></div><div class="date-dz">' 
